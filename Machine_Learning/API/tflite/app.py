...
predictor = Predict(r'C:\Users\eldon\Downloads\model_alex\tflite\mobilenet_model.tflite', label)
prompt = Prompt(r'C:\Users\eldon\Downloads\model_alex\combined_nutrition_data.csv')
